---
type: entity
tags: [GTSAM, C++ API, Optimization, DoglegOptimizer]
created: 2026-05-29
updated: 2026-05-29
sources:
...
> **类** | 头文件: `DoglegOptimizer.h` | [在线文档](https://gtsam.org/doxygen/)
...
```cpp
DoglegOptimizer(const NonlinearFactorGraph & graph, const Values & initialValues, const DoglegParams & params)
```
...
```cpp
using shared_ptr = std::shared_ptr< DoglegOptimizer >
```
...
`DoglegOptimizer` 用于 GTSAM factor graph 优化流程中。
