---
type: entity
tags: [GTSAM, C++ API, Navigation, GPSFactor]
created: 2026-05-29
updated: 2026-05-29
sources:
...
- 继承自 `gtsam::NoiseModelFactorT< Pose3 >`
...
```cpp
Vector evaluateError(const Pose3 & nTb, OptionalMatrixType H) const
```
vector of errors
...
`GPSFactor` 用于 GTSAM factor graph 优化流程中。
