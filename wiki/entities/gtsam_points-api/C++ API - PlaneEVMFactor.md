---
type: entity
tags: [gtsam_points, C++ API, Bundle Adjustment, PlaneEVMFactor]
created: 2026-05-29
updated: 2026-05-29
sources:
...
- 继承自 `gtsam_points::EVMBundleAdjustmentFactorBase`
...
`PlaneEVMFactor` 用于 GTSAM factor graph 优化流程中。
