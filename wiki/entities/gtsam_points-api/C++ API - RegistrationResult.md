---
type: entity
tags: [gtsam_points, C++ API, Point Cloud & Trajectory, RegistrationResult]
created: 2026-05-29
updated: 2026-05-29
sources:
...
> **结构体** | 头文件: `registration_result.hpp` | [在线文档](https://koide3.github.io/gtsam_points/doc_cpp/index.html)
...
`RegistrationResult` 用于 GTSAM factor graph 优化流程中。
