---
type: entity
tags: [gtsam_points, C++ API, Nearest Neighbor, KdTree]
created: 2026-05-29
updated: 2026-05-29
sources:
...
> **结构体** | 头文件: `kdtree.hpp` | [在线文档](https://koide3.github.io/gtsam_points/doc_cpp/index.html)
...
`KdTree` 用于 GTSAM factor graph 优化流程中。
